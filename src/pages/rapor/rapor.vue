  ...
  <div v-if="homediv">
    ...
    <div style="text-align:center" class="q-mt-sm">
        <q-btn
            ...
            style="width:60%;"
        >
          <label class="font7 fs18">Teknik Komputer<br/>
          <label class="font8 fs14">Universitas Komputer Indonesia</label></label>
  ...
  <div v-if="rekomendasi">
    <div class="q-ma-md">
      <div style="text-align:right;" class="q-mb-md">
        <q-btn rounded icon="sort" color="secondary" label="Urutkan" no-caps @click="recommenSort()"/>
      </div>
